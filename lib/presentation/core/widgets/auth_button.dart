...
import 'package:flutter_college/presentation/core/widgets/circular_image_holder.dart';
    ...
    switch (item) {
      case SocialItem.apple:
        return ButtonBuilder(
          onPressed: onPressed,
          imagePath: 'res/images/apple.png',
          text: 'Apple',
          height: height,
          width: width,
          mini: mini,
      ...
      case SocialItem.github:
        return ButtonBuilder(
          ...
          imagePath: 'res/images/github.png',
          text: 'Github',
      ...
      case SocialItem.google:
        return ButtonBuilder(
          onPressed: onPressed,
          imagePath: 'res/images/google.png',
          text: 'Google',
          height: height,
          width: width,
          mini: mini,
      ...
      case SocialItem.twitter:
        return ButtonBuilder(
          ...
          color: Colors.blue,
          textColor: Colors.white,
          imagePath: 'res/images/twitter.png',
          text: 'Twitter',
          height: height,
          width: width,
          mini: mini,
      ...
      case SocialItem.facebook:
        return ButtonBuilder(
          ...
          color: Colors.blue,
          textColor: Colors.white,
          imagePath: 'res/images/facebook.png',
          text: 'Facebook',
          height: height,
          width: width,
          mini: mini,
